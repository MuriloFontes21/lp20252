...
from tkinter import label, grid, entry, focus
HOJE = datetime.now()
...
def q23():
 ...
 if prato in prato and sobremesa in sobremesa and bebida in bebida:
     total_calorias = prato[prato] + sobremesa[sobremesa] + bebida[bebida]
...
def q24():
 ...
 if digitos:
     ...
     if ultimo_digito in mes:
         mes = mes[ultimo_digito]
